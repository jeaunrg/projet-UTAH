...
def get_default_results(patient):
    ...
    ------
    results: dict
        Dictionnaire contentant certaines réponses de l'algorithme remplies en avance.
    ...
    for values in patient.traitements.values():
        ...
        if values['traitement'] == "Aspirine, Asaflow, Cardioaspirine" and values['pathologie'] == "Prévention secondaire": # TO DO: and monotherapy
            results['aspirin_mono'] = 'Oui'

        if values['traitement'] == "Clopidogrel, PLAVIX" and values['pathologie'] == "Prévention secondaire": # TO DO: and monotherapy
