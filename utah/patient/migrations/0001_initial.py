    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ddi', models.DateTimeField(blank=True, null=True, verbose_name="Date de l'intervention")),
                ...
                ('ddconsult', models.DateTimeField(auto_now_add=True, verbose_name='Date de la consultation')),
                ...
                ('date_derniere_prise_th1', models.DateTimeField(blank=True, null=True, verbose_name='Date de dernière prise théorique (premier traitement)')),
                ...
                ('date_derniere_prise_th2', models.DateTimeField(blank=True, null=True, verbose_name='Date de dernière prise théorique (deuxième traitement)')),
