    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pathologie', models.CharField(choices=[('Prevention primaire', 'Prevention primaire'), ('Prevention secondaire', 'Prevention secondaire'), ('Fibrilation Atriale', 'Fibrilation Atriale'), ('Valvulopathie', 'Valvulopathie'), ('Pontages Cardiaques', 'Pontages Cardiaques'), ('Chirurgie Vasculaire Arterielle', 'Chirurgie Vasculaire Arterielle'), ('ATCD EP', 'ATCD EP'), ('ATCD TVP', 'ATCD TVP'), ('ATCD AVC + AIT', 'ATCD AVC + AIT'), ('CMI', 'CMI'), ('Stents Cardiaques', 'Stents Cardiaques'), ('Greffe', 'Greffe'), ('Thrombose Porte', 'Thrombose Porte'), ('Thrombose Mesenterique', 'Thrombose Mesenterique')], default='Prevention primaire', max_length=40, verbose_name='Pathologie justifiant le traitement')),
