...
class PreopPatientFileForm(CustomModelForm):
    class Meta:
        model = Patient
        fields = ["height", "weight", "ddn", "ddi", "intervention", "chirurgie", "pathologie", "traitement1",
                  "traitement2"]
...
class UpdatePatientFileForm(CustomModelForm):
    class Meta:
        model = Patient
        fields = ["height", "weight", "ddn", "ddi", "intervention", "chirurgie", "pathologie", "traitement1",
                  "traitement2", "schema_therap", "date_derniere_prise1", "inobservance1", "date_derniere_prise2",
